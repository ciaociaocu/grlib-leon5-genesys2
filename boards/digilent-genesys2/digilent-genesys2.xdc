...
create_clock -period 5.000 -name clk200p [get_ports clk200p]
...
#set_property DIFF_TERM false [get_ports clk200p]
#set_property DIFF_TERM false [get_ports clk200n]
...
#set_property -dict {PACKAGE_PIN B19 IOSTANDARD LVCMOS12} [get_ports {button[4]}]
